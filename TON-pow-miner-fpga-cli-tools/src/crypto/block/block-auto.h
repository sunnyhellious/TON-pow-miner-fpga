...
struct ConsensusConfig final : TLB_Complex {
  enum { consensus_config, consensus_config_new, consensus_config_v3 };
  static constexpr int cons_len_exact = 8;
  static constexpr unsigned char cons_tag[3] = { 0xd6, 0xd7, 0xd8 };
