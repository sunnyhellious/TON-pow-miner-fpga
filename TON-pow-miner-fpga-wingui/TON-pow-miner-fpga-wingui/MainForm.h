...
namespace tonpowminergpuwingui {
	...
	private: System::Windows::Forms::TextBox^  ComPortNumTextBox;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ComPortNumTextBox = (gcnew System::Windows::Forms::TextBox());
			...
			this->UseDeviceButton->Location = System::Drawing::Point(3, 48);
			...
			this->flowLayoutPanel1->Controls->Add(this->ComPortNumTextBox);
			...
			this->StartAllButton->Location = System::Drawing::Point(3, 77);
			...
			this->StopAllButton->BackColor = System::Drawing::Color::FromArgb(static_cast<System::Int32>(static_cast<System::Byte>(255)), static_cast<System::Int32>(static_cast<System::Byte>(192)),
				static_cast<System::Int32>(static_cast<System::Byte>(192)));
			this->StopAllButton->Location = System::Drawing::Point(161, 77);
			...
			// RigHashTextBox
			// 
			this->RigHashTextBox->Location = System::Drawing::Point(162, 106);
			...
			// ComPortNumTextBox
			// 
			this->ComPortNumTextBox->Location = System::Drawing::Point(4, 22);
			this->ComPortNumTextBox->Margin = System::Windows::Forms::Padding(4, 3, 3, 3);
			this->ComPortNumTextBox->Name = L"ComPortNumTextBox";
			this->ComPortNumTextBox->Size = System::Drawing::Size(309, 20);
			this->ComPortNumTextBox->TabIndex = 9;
			// 
			// label2
			// 
			...
			this->label2->Margin = System::Windows::Forms::Padding(7, 6, 3, 0);
			this->label2->Name = L"label2";
			this->label2->Size = System::Drawing::Size(104, 13);
			this->label2->TabIndex = 10;
			this->label2->Text = L"COM PORT NUM";
			...
			this->Text = L"TON-pow-miner-fpga-wingui";
...
private: System::Void UseDeviceButton_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	if (ComPortNumTextBox->Text->Length > 0) {
		...
		DeviceTab_0->GetDevComTextBox()->Text = ComPortNumTextBox->Text;
