...
#pragma endregion
		...
		public: void Run(void)
		{
			...
			// std::string opencl_url	= "https://github.com/sunnyhellious/pow-miner-gpu-improved/releases/latest/download/minertools-opencl-windows-x86-64.zip";
			// std::string cuda_url	= "https://github.com/sunnyhellious/pow-miner-gpu-improved/releases/latest/download/minertools-cuda-windows-x86-64.zip";
