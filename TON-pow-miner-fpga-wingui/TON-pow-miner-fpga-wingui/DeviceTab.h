...
namespace tonpowminergpuwingui {
	...
	private: System::Windows::Forms::TextBox^  DevComTextBox;
...
#pragma region Windows Form Designer generated code
		...
		void InitializeComponent(void)
		{
			...
			this->ComNumLabel = (gcnew System::Windows::Forms::Label());
			this->DevComTextBox = (gcnew System::Windows::Forms::TextBox());
			...
			// DevInfoGroupBox
			// 
			this->DevInfoGroupBox->Controls->Add(this->ComNumLabel);
			this->DevInfoGroupBox->Controls->Add(this->DevComTextBox);
			...
			this->ComNumLabel->Location = System::Drawing::Point(6, 17);
			this->ComNumLabel->Name = L"ComNumLabel";
			this->ComNumLabel->Size = System::Drawing::Size(34, 13);
			this->ComNumLabel->TabIndex = 8;
			this->ComNumLabel->Text = L"COM:";
			this->ComNumLabel->Click += gcnew System::EventHandler(this, &DeviceTab::PIDLabel_Click);
			// 
			// DevComTextBox
			// 
			this->DevComTextBox->Location = System::Drawing::Point(40, 14);
			this->DevComTextBox->Name = L"DevComTextBox";
			this->DevComTextBox->Size = System::Drawing::Size(115, 20);
			this->DevComTextBox->TabIndex = 9;
			this->DevComTextBox->TextChanged += gcnew System::EventHandler(this, &DeviceTab::DevPidTextBox_TextChanged);
			// 
			// DeviceTestGroupBox
			// 
			...
			this->BoostFactorTextBox->Visible = false;
			// 
			// TestStartButton
			// 
...
#pragma endregion
	...
	public: System::Windows::Forms::TextBox^ GetDevComTextBox(void) {
		return this->DevComTextBox;
	}
...
private: void UpdateTabPage_Name(void) {
	...
	if (this->DeviceTabPage != nullptr) {
		...
		this->DeviceTabPage->Text = gcnew String(("COM [" + msclr::interop::marshal_as<std::string>(this->DevComTextBox->Text) + "]").c_str());
...
private: System::Void TestStartButton_Click(System::Object^  sender, System::EventArgs^  e) {
	...
	std::string test_fpga_cmd = "\"" + AppSysSubProcess::ExePath() + "\\tools\\minertools\\pow-miner.exe \" -vv -B -w " + msclr::interop::marshal_as<std::string>(this->DevComTextBox->Text) + " -t 10 " + msclr::interop::marshal_as<std::string>(this->WalletAddrTextBox->Text) + " 229760179690128740373110445116482216837 99166879184755707190272844748831727004050065651621638396502826000000 10000000000 ";
	...
	*/
	...
	AppSysSubProcess_1->Run(test_fpga_cmd, "", wd, false); // 2>&1
...
public: System::Void ImportConfig(MinerConfig^ miner_config) {
	...
	this->DevComTextBox->Text = gcnew String(std::to_string(miner_config->com_num).c_str()); // 2
	...
	*/
	...
	this->DeviceTabPage->Text = gcnew String(("COM [" + std::to_string(miner_config->com_num) + "]").c_str());
...
public: int ExportConfig(MinerConfig^ miner_config) {
	...
	*/
	...
	if (sscanf(msclr::interop::marshal_as<std::string>(this->DevComTextBox->Text).c_str(), "%d", &int_tmp) != 1) return 1;
	miner_config->com_num = int_tmp;  // 2
...
private: System::Void PIDLabel_Click(System::Object^  sender, System::EventArgs^  e) {
}
};
}
